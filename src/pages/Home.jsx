    ...
    <>
      ...
      <header className="text-center text-white">
        <div className="container">
          <div className="d-flex flex-column justify-content-center align-items-center vh-100 pt-5">
            ...
            <button className="btn btn-primary explore-btn">Explore Events</button>
          </div>
        </div>
      </header>
      ...
      <main>
        ...
        <section className="container py-5">
          <h2 className="text-center mb-4 fs-1 fw-bold">What Our Community Says</h2>
        ...
        <section className="py-5 text-center">
          <div className="container">
            ...
            <p>
              Don't miss out on the latest events and volunteering opportunities.
